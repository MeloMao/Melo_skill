...
* target  
My first thought is CET4 and CET6, because it's a common English level distinction, and I passed the level 4, but not by 6, so my first goal is to pass the CET6. Of course, it is also my daily goal to improve my spoken English and read and write skills.
### Github #
* introduction  
